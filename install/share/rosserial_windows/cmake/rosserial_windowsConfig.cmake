...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/bugra/Projects/flying-knight/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/bugra/Projects/flying-knight/devel)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/bugra/Projects/flying-knight/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bugra/Projects/flying-knight/install/${idir}'.  Ask the maintainer 'Kareem Shehata <kshehata@clearpathrobotics.com>' to fix it.")
    endif()
